...
static const struct iio_chan_spec xadc_7s_channels[] = {
	...
	XADC_7S_CHAN_VOLTAGE(8, 11, XADC_REG_VPVN, "vpvn", false),
	XADC_7S_CHAN_VOLTAGE(9, 16, XADC_REG_VAUX(0), "vaux0", false),
	XADC_7S_CHAN_VOLTAGE(10, 17, XADC_REG_VAUX(1), "vaux1", false),
	XADC_7S_CHAN_VOLTAGE(11, 18, XADC_REG_VAUX(2), "vaux2", false),
	XADC_7S_CHAN_VOLTAGE(12, 19, XADC_REG_VAUX(3), "vaux3", false),
	XADC_7S_CHAN_VOLTAGE(13, 20, XADC_REG_VAUX(4), "vaux4", false),
	XADC_7S_CHAN_VOLTAGE(14, 21, XADC_REG_VAUX(5), "vaux5", false),
	XADC_7S_CHAN_VOLTAGE(15, 22, XADC_REG_VAUX(6), "vaux6", false),
	XADC_7S_CHAN_VOLTAGE(16, 23, XADC_REG_VAUX(7), "vaux7", false),
	XADC_7S_CHAN_VOLTAGE(17, 24, XADC_REG_VAUX(8), "vaux8", false),
	XADC_7S_CHAN_VOLTAGE(18, 25, XADC_REG_VAUX(9), "vaux9", false),
	XADC_7S_CHAN_VOLTAGE(19, 26, XADC_REG_VAUX(10), "vaux10", false),
	XADC_7S_CHAN_VOLTAGE(20, 27, XADC_REG_VAUX(11), "vaux11", false),
	XADC_7S_CHAN_VOLTAGE(21, 28, XADC_REG_VAUX(12), "vaux12", false),
	XADC_7S_CHAN_VOLTAGE(22, 29, XADC_REG_VAUX(13), "vaux13", false),
	XADC_7S_CHAN_VOLTAGE(23, 30, XADC_REG_VAUX(14), "vaux14", false),
	XADC_7S_CHAN_VOLTAGE(24, 31, XADC_REG_VAUX(15), "vaux15", false),
};
