...
{
	return zynqmp_pm_invoke_fn(PM_IOCTL, 0, IOCTL_USB_SET_STATE, state, value, NULL);
}
...
{
	return zynqmp_pm_invoke_fn(PM_IOCTL, 0, IOCTL_SET_SGMII_MODE, enable, 0, NULL);
}
EXPORT_SYMBOL_GPL(zynqmp_pm_set_sgmii_mode);

int zynqmp_pm_set_tapdelay_bypass(u32 index, u32 value)
{
	return zynqmp_pm_invoke_fn(PM_IOCTL, 0, IOCTL_SET_TAPDELAY_BYPASS, index, value, NULL);
}
