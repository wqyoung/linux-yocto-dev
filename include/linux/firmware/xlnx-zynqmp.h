...
/* Macros to extract data like node-class, subclass, node-type from NodeId */
...
enum XPm_NodeClass {
	XPM_NODECLASS_MIN = 0,
	XPM_NODECLASS_POWER = 1,
	XPM_NODECLASS_CLOCK = 2,
	XPM_NODECLASS_RESET = 3,
	XPM_NODECLASS_MEMIC = 4,
	XPM_NODECLASS_STMIC = 5,
	XPM_NODECLASS_DEVICE = 6,
	XPM_NODECLASS_SUBSYSTEM = 7,
	XPM_NODECLASS_ISOLATION = 8,
	XPM_NODECLASS_PROTECTION = 9,
	XPM_NODECLASS_EVENT = 10,
	XPM_NODECLASS_MONITOR = 11,
	XPM_NODECLASS_MAX = 12,
};
